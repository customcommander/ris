...
function id(x) { return x[0]; }
 const lexer = require("./lexer.js"); var grammar = {
    ...
    {"name": "DATABASE", "symbols": [(lexer.has("DB") ? {type: "DB"} : DB), (lexer.has("SEP") ? {type: "SEP"} : SEP), (lexer.has("CONTENT") ? {type: "CONTENT"} : CONTENT), "__"], "postprocess": ([,,{value}]) => ({key: 'db_name'       , value})},
